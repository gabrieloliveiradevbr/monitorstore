            ...
            <form action="{{ route('loja.monitores') }}" method="GET" class="filter-form">
                ...
                <div class="filter-group">
                    ...
                    <select name="marca" id="marca" class="filter-select">
                        ...
                        @foreach (['LG', 'Samsung', 'Dell', 'AOC', 'Asus', 'BenQ', 'Philips', 'ViewSonic', 'Acer', 'Lenovo', 'MSI', 'Gigabyte'] as $m)
                ...
                <div class="filter-group">
                    ...
                    <select name="preco" id="preco" class="filter-select">
                        ...
                        <option value="ate-1000" {{ ($filtros['preco'] ?? '') == 'ate-1000' ? 'selected' : '' }}>Até R$
                            1.000</option>
                        <option value="1000-2000" {{ ($filtros['preco'] ?? '') == '1000-2000' ? 'selected' : '' }}>R$ 1.000
                            a R$ 2.000</option>
                        <option value="acima-2000"{{ ($filtros['preco'] ?? '') == 'acima-2000' ? 'selected' : '' }}>Acima de
                            R$ 2.000</option>
                    </select>
                </div>
            ...
            @forelse($produtos as $produto)
                <article class="store-card">
                    ...
                    <div class="card-content">
                        ...
                        <p class="card-desc">
                            {{ trim(strip_tags($produto->descricao ?? '')) !== '' ? \Illuminate\Support\Str::limit(strip_tags($produto->descricao), 110, '...') : 'Detalhes do produto indisponíveis no momento.' }}
                        </p>
            ...
            @empty
                ...
                <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px;">
                    ...
                    <p style="color:#6b7280; margin-top:0.5rem;">Tente outros filtros ou <a
                            href="{{ route('loja.monitores') }}">limpe os filtros</a>.</p>
                </div>
            @endforelse
