        ...
        <form action="{{ route('loja.acessorios') }}" method="GET" class="filter-form">
            ...
            <div class="filter-group">
                ...
                <select name="preco" id="preco" class="filter-select">
                    ...
                    <option value="ate-150"  {{ ($filtros['preco'] ?? '') == 'ate-150'  ? 'selected' : '' }}>Até R$ 150</option>
                    <option value="150-300"  {{ ($filtros['preco'] ?? '') == '150-300'  ? 'selected' : '' }}>R$ 150 a R$ 300</option>
                    <option value="acima-300"{{ ($filtros['preco'] ?? '') == 'acima-300'? 'selected' : '' }}>Acima de R$ 300</option>
                </select>
            </div>
    ...
    <section class="store-product-grid">
        ...
        @empty
            ...
            <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px;">
                ...
                <p style="color:#6b7280; margin-top:0.5rem;">Tente outros filtros ou <a href="{{ route('loja.acessorios') }}">limpe os filtros</a>.</p>
            </div>
